      ...
      <section className="py-20 bg-gradient-to-br from-[#f0f8ff] to-[#dbeafe]">
        <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-14">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-[#2563eb] mb-6">
              How it All Began
            </h2>
  ...
  <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-14">
    ...
    <div className="flex-1">
      ...
      <div className="space-y-5 text-gray-700 text-lg leading-relaxed">
        ...
        <div>
          <h5 className="font-bold text-[#2563eb] mb-1">Early Childhood Education</h5>
        ...
        <div>
          <h5 className="font-bold text-[#2563eb] mb-1">Primary Education</h5>
        ...
        <div>
          <h5 className="font-bold text-[#2563eb] mb-1">Secondary Education</h5>
          <ul className="ml-4 space-y-1 text-gray-600">
      ...
      <section className="py-20 bg-gradient-to-br from-[#ecfdf5] to-[#d1fae5]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-[#2563eb]">
              What We Stand For
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                ...
                <h4 className="text-xl font-bold text-[#2563eb] mb-2">
                  {value.title}
                </h4>
