...
export default function Admissions() {
  ...
  const inputClass = "w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#e600a9] text-gray-700 text-sm"
  const labelClass = "block text-sm font-bold text-[#e600a9] mb-2"
    ...
    return (
      <div className="min-h-screen bg-[#fff0fb] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl p-12 shadow-xl max-w-lg w-full text-center">
          ...
          <h2 className="text-3xl font-bold font-serif text-[#e600a9] mb-4">Application Submitted!</h2>
          ...
          <div className="bg-blue-50 rounded-xl p-4 mb-8">
            <p className="text-sm text-[#e600a9] font-bold">What happens next?</p>
          ...
          <button
            ...
            className="bg-[#e600a9] hover:bg-[#ff33c7] text-white font-bold px-8 py-3 rounded-xl transition-colors"
          >
      ...
      <div>
        ...
        <section className="py-20 bg-[#fff0fb]">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="bg-[#e600a9] text-white rounded-2xl p-10 shadow-md mb-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-[#ff00c8] rounded-full flex items-center justify-center">
                  <Lock size={20} className="text-[#e600a9]" />
                </div>
              ...
              <div className="bg-white/10 rounded-xl p-6 mb-6">
                <h3 className="text-[#ff00c8] font-bold text-lg mb-4">Payment Details</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-pink-100">Amount:</span>
                    <span className="text-white font-bold text-xl">GHS 430.00</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-pink-100">Account Number:</span>
                    <span className="text-white font-bold">0594330816</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-pink-100">Account Name:</span>
                    <span className="text-white font-bold">Goldenintels Educare</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-pink-100">Payment Method:</span>
                    <span className="text-white font-bold">Mobile Money / Bank Transfer</span>
                  </div>
                </div>
              </div>
              <div className="bg-[#ff00c8]/20 rounded-xl p-4">
                <p className="text-[#ff00c8] text-sm font-bold mb-1">After Payment:</p>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-sm border border-gray-100">
              <h3 className="text-2xl font-bold font-serif text-[#e600a9] mb-2">Already Have a Serial Number?</h3>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold text-[#e600a9] mb-2">Serial Number</label>
                  <input
                    type="text"
                    value={serialNumber}
                ...
                <div>
                  <label className="block text-sm font-bold text-[#e600a9] mb-2">PIN</label>
                  <input
                    type="password"
                    value={pin}
              ...
              <div className="mt-6 bg-[#fff0fb] rounded-xl p-4">
                <p className="text-sm text-gray-500">
                  <strong className="text-[#e600a9]">Need help?</strong> Contact the school office for assistance with your serial number and PIN.
                </p>
  ...
  return (
    <div>
      ...
      {/* Hero Banner */}
      <section className="bg-[#e600a9] text-white py-20 text-center">
      ...
      <section className="py-20 bg-[#fff0fb]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            <span className="inline-block bg-[#ff00c8] text-[#e600a9] text-sm font-bold px-4 py-1 rounded-full mb-4">Process</span>
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-[#e600a9] mb-4">Admission Process</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="bg-[#e600a9] text-white rounded-2xl p-8 text-center shadow-md">
                <div className="w-14 h-14 bg-[#ff00c8] rounded-full flex items-center justify-center mx-auto mb-4 text-[#e600a9]">
                  {step.icon}
                </div>
                <span className="text-[#ff00c8] text-sm font-bold">{step.step}</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-[#e600a9] text-white rounded-2xl p-10 shadow-md">
            ...
            <h4 className="text-[#ff00c8] font-bold mb-4">Required Documents</h4>
            <ul className="space-y-3">
              {requirements.map((req, index) => (
                <li key={index} className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-[#ff00c8] mt-0.5 shrink-0" />
                  <span className="text-pink-100 text-sm">{req}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-[#4a235a] text-white rounded-2xl p-10 shadow-md">
            ...
            <div className="space-y-6">
              <div className="bg-white/10 rounded-xl p-4">
                <h4 className="text-[#ff00c8] font-bold mb-1">Application Deadline</h4>
                <p className="text-purple-200 text-sm">Rolling admissions — Applications accepted first and second term</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4">
                <h4 className="text-[#ff00c8] font-bold mb-1">Assessment Period</h4>
                <p className="text-purple-200 text-sm">Scheduled within 1 week of application submission</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4">
                <h4 className="text-[#ff00c8] font-bold mb-1">Enrollment Confirmation</h4>
      ...
      <section className="py-20 bg-[#fff0fb]">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mb-10">
            <span className="inline-block bg-[#ff00c8] text-[#e600a9] text-sm font-bold px-4 py-1 rounded-full mb-4">Apply Now</span>
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-[#e600a9] mb-4">Admission Form</h2>
            <p className="text-gray-600">Complete all sections below to begin your admission process.</p>
          </div>

          {/* Learner's Data */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Learner's Data</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-6">
                  <div className="w-24 h-24 rounded-xl bg-[#ffe0f7] overflow-hidden border-2 border-[#e600a9] flex items-center justify-center">
                    {photoPreview ? (
          ...
          {/* Family Data */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Family Data</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
          ...
          {/* Father Info */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Father Info</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
          ...
          {/* Mother Info */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Mother Info</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
          ...
          {/* Significant Data */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Significant Data</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
          ...
          {/* Emergency Contact */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Emergency Contact</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
          ...
          {/* Document Uploads */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-6 pb-2 border-b border-gray-100">Child's National Health Insurance Scheme (NHIS) Card</h3>
            ...
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mt-8 mb-4 pb-2 border-b border-gray-100">Guardian's Ghana Card (National ID)</h3>
         ...
         {/* Admission Booklet Section */}
          <div className={sectionClass}>
            <h3 className="text-xl font-bold font-serif text-[#e600a9] mb-2 pb-2 border-b border-gray-100">
            ...
            <div className="bg-blue-50 rounded-xl p-5 mb-4">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-[#e600a9] rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0">1</div>
                <div className="flex-1">
                  <h4 className="font-bold text-[#e600a9] mb-1">Download Admission Booklet</h4>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-[#e600a9] hover:bg-[#ff33c7] text-white font-bold px-6 py-2 rounded-lg text-sm transition-colors"
                  >
                    <Download size={16} />
            ...
            {/* Step 2 - Sign */}
            <div className="bg-pink-50 rounded-xl p-5 mb-4">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-[#ff00c8] rounded-full flex items-center justify-center text-[#e600a9] font-bold text-sm shrink-0">2</div>
                <div>
                  <h4 className="font-bold text-[#e600a9] mb-1">Read, Sign and Save</h4>
            ...
            <div className="bg-green-50 rounded-xl p-5 mb-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#e600a9] mb-1">Upload Signed Booklet</h4>
                  <p className="text-sm text-gray-600 mb-3">
            ...
            {/* Consent Checkbox */}
            <div className="bg-[#e600a9] rounded-xl p-5">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  checked={consentGiven}
                  onChange={e => setConsentGiven(e.target.checked)}
                  className="w-5 h-5 mt-0.5 accent-[#e600a9] shrink-0"
                />
          ...
          <div className="text-center">
            <button
              ...
              className="bg-[#e600a9] hover:bg-[#ff33c7] text-white font-bold px-16 py-4 rounded-xl text-lg transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
