...
export default function Admissions() {
  ...
  const inputClass = "w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#2563eb] text-gray-700 text-sm text-base"
  const labelClass = "block text-sm font-bold text-[#2563eb] mb-2"
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl p-12 shadow-xl max-w-lg w-full text-center">
          ...
          <div className="bg-blue-50 rounded-xl p-4 mb-8">
            <p className="text-sm text-[#2563eb] font-bold">What happens next?</p>
          ...
          <button
            ...
            className="bg-[#2563eb] hover:bg-violet-700 text-white font-bold px-8 py-3 rounded-xl transition-colors"
          >
      ...
      <div>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
          <div className="max-w-4xl mx-auto px-4">
            <div className="bg-[#2563eb] text-white rounded-2xl p-10 shadow-md mb-8">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-[#2563eb] mb-2">Serial Number</label>
                  <input
                    type="text"
                    value={serialNumber}
                    onChange={e => setSerialNumber(e.target.value)}
                    placeholder="e.g. GI-2026-12345"
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#2563eb] text-gray-700 text-base"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold text-[#2563eb] mb-2">PIN</label>
                  <input
                    type="password"
                    value={pin}
                ...
                <button
                  ...
                  className="sm:col-span-2 w-full bg-[#2563eb] hover:bg-violet-700 text-white font-bold py-3 rounded-xl transition-colors disabled:opacity-50"
                >
              ...
              <div className="mt-6 bg-blue-50 rounded-xl p-4">
                <p className="text-sm text-gray-500">
                  <strong className="text-[#2563eb]">Need help?</strong> Contact the school office for assistance with your serial number and PIN.
                </p>
    ...
    <div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            <span className="inline-block bg-[#2563eb] text-white text-sm font-bold px-4 py-1 rounded-full mb-4">Process</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="bg-white border border-gray-100 rounded-2xl p-8 text-center shadow-sm hover:shadow-md transition-shadow">
                <div className="w-14 h-14 bg-[#2563eb] text-white rounded-full flex items-center justify-center mx-auto mb-4">
                  {step.icon}
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-[#2563eb] text-white rounded-2xl p-10 shadow-md">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-10">
            <span className="inline-block bg-[#2563eb] text-white text-sm font-bold px-4 py-1 rounded-full mb-4">Apply Now</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-6">
                  <div className="w-24 h-24 rounded-xl bg-blue-100 overflow-hidden border-2 border-[#2563eb] flex items-center justify-center">
                    {photoPreview ? (
          ...
          <div className={sectionClass}>
            ...
            <div className="bg-blue-50 rounded-xl p-5 mb-4">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-[#2563eb] rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0">1</div>
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-[#2563eb] hover:bg-violet-700 text-white font-bold px-6 py-2 rounded-lg text-sm transition-colors"
                  >
                    <Download size={16} />
            ...
            <div className="bg-blue-50 rounded-xl p-5 mb-4">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-[#2563eb] rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0">2</div>
                <div>
          ...
          <div className="text-center">
            <button
              ...
              className="bg-[#2563eb] hover:bg-violet-700 text-white font-bold px-16 py-4 rounded-xl text-lg transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
