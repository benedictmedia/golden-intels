...
const clubs = [
  {
    ...
    tagColor: 'bg-sky-500 text-sky-700',
                ...
                <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <div className={`${club.color} p-6`}>
                    ...
                    <div className={`${club.textColor} text-xs mb-4 space-y-1`}>
                      <p><span className="text-sky-600 font-bold">Meets:</span> {club.meets}</p>
                      <p><span className="text-sky-600 font-bold">Open to:</span> {club.openTo}</p>
                    </div>
                    <button
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-bold font-serif text-sky-700 mb-4">{selected.name}</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">{selected.fullDescription}</p>

              <div className="bg-sky-50 rounded-xl p-4 mb-8 space-y-2">
                <p className="text-gray-700">
                  <span className="font-bold text-sky-700">Meets: </span>{selected.meets}
                </p>
                <p className="text-gray-700">
                  <span className="font-bold text-sky-700">Open to: </span>{selected.openTo}
                </p>
              </div>
   ...
   {/* Why Join Our Activities */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {/* Call To Action */}
          <div className="bg-sky-600 rounded-2xl p-12 text-center shadow-md">
            ...
            <button
              ...
              className="bg-sky-500 hover:bg-sky-300 text-sky-700 font-bold px-10 py-3 rounded-lg text-lg transition-colors"
            >
