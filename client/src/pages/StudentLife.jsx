...
const clubs = [
  {
    ...
    tagColor: 'bg-[#ff00c8] text-[#e600a9]',
...
export default function StudentLife() {
  ...
  return (
    <div>
      ...
      {/* Clubs Grid */}
      <section className="py-16 bg-gradient-to-br from-[#fff0fb] to-[#ffd6f3]">
                ...
                <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <div className={`${club.color} p-6`}>
                    ...
                    <div className={`${club.textColor} text-xs mb-4 space-y-1`}>
                      <p><span className="text-[#ff00c8] font-bold">Meets:</span> {club.meets}</p>
                      <p><span className="text-[#ff00c8] font-bold">Open to:</span> {club.openTo}</p>
                    </div>
                    <button
                      onClick={() => setSelected(club)}
                      className="w-full bg-[#ff00c8] hover:bg-[#ff66dc] text-[#e600a9] font-bold py-2 rounded-lg text-sm transition-colors"
                    >
                      Learn More
                    </button>
                  </div>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-bold font-serif text-[#e600a9] mb-4">{selected.name}</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">{selected.fullDescription}</p>

              <div className="bg-[#fff0fb] rounded-xl p-4 mb-8 space-y-2">
                <p className="text-gray-700">
                  <span className="font-bold text-[#e600a9]">Meets: </span>{selected.meets}
                </p>
                <p className="text-gray-700">
                  <span className="font-bold text-[#e600a9]">Open to: </span>{selected.openTo}
                </p>
              </div>

              <button
                onClick={() => setSelected(null)}
                className="w-full bg-[#e600a9] hover:bg-[#ff33c7] text-white font-bold py-3 rounded-xl transition-colors"
              >
                Close
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-[#e600a9] text-white rounded-2xl p-8 shadow-md">
              <div className="w-12 h-12 bg-[#ff00c8] rounded-full flex items-center justify-center mb-4">
                <span className="text-[#e600a9] font-bold text-lg">🤝</span>
              </div>
            ...
            <div className="bg-[#ff00c8] text-[#e600a9] rounded-2xl p-8 shadow-md">
              <div className="w-12 h-12 bg-[#e600a9] rounded-full flex items-center justify-center mb-4">
          ...
          {/* Call To Action */}
          <div className="bg-[#e600a9] rounded-2xl p-12 text-center shadow-md">
            ...
            <button
              ...
              className="bg-[#ff00c8] hover:bg-[#ff66dc] text-[#e600a9] font-bold px-10 py-3 rounded-lg text-lg transition-colors"
            >
