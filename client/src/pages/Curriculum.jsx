              ...
              {filtered.map((program, index) => (
                <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="text-xl font-bold text-sky-700 mb-3">{program.title}</h3>
                    <p className="text-gray-600 leading-relaxed mb-2">{program.overview}</p>

                    <div className="mt-4 mb-2">
                      <span className="text-sm font-bold text-sky-700">Target Audience: </span>
                      <span className="text-sm text-gray-600">{program.targetAudience}</span>
                    </div>

                    <div className="mt-2 mb-4">
                      <span className="text-sm font-bold text-sky-700">Learning Outcomes: </span>
                      <span className="text-sm text-gray-600">{program.shortOutcome}</span>
                    </div>

                    <button
                      onClick={() => setSelected(program)}
                      className="bg-sky-600 hover:bg-sky-400 text-white font-bold px-6 py-2 rounded-lg text-sm transition-colors"
                    >
                      Learn More
                    </button>
                  </div>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-bold font-serif text-sky-700 mb-4">{selected.title}</h2>

              <div className="space-y-5 text-gray-600">
                <div>
                  <h4 className="font-bold text-sky-700 mb-1">Overview</h4>
                  <p className="leading-relaxed">{selected.overview}</p>
                </div>
                <div>
                  <h4 className="font-bold text-sky-700 mb-1">Target Audience</h4>
                  <p>{selected.targetAudience}</p>
                </div>
                <div>
                  <h4 className="font-bold text-sky-700 mb-1">Learning Outcomes</h4>
                  <p className="leading-relaxed">{selected.fullOutcome}</p>
                </div>
                <div>
                  <h4 className="font-bold text-sky-700 mb-1">Curriculum Overview</h4>
              ...
              <button
                onClick={() => setSelected(null)}
                className="mt-8 w-full bg-sky-600 hover:bg-sky-400 text-white font-bold py-3 rounded-xl transition-colors"
              >
                Close
              </button>
            </div>
     ...
     <section className="py-20 bg-gradient-to-br from-sky-50 to-sky-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-sky-600 text-white rounded-2xl p-8 text-center shadow-md">
              <div className="w-14 h-14 bg-sky-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-sky-700 font-bold text-xl">C</span>
              </div>
            ...
            <div className="bg-[#4a235a] text-white rounded-2xl p-8 text-center shadow-md">
              <div className="w-14 h-14 bg-sky-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-sky-700 font-bold text-xl">G</span>
              </div>
            ...
            <div className="bg-[#0f6e56] text-white rounded-2xl p-8 text-center shadow-md">
              <div className="w-14 h-14 bg-sky-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-sky-700 font-bold text-xl">E</span>
              </div>
            ...
            <div className="bg-sky-500 text-sky-700 rounded-2xl p-8 text-center shadow-md">
              <div className="w-14 h-14 bg-sky-600 rounded-full flex items-center justify-center mx-auto mb-4">
