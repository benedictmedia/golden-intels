            ...
            {activities.map((activity, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div className={`${activity.color} p-6 h-full`}>
                  <span className="inline-block bg-[#ff00c8] text-[#e600a9] text-xs font-bold px-3 py-1 rounded-full mb-3">
                    {activity.category}
                  </span>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-bold font-serif text-[#e600a9] mb-4">{selected.category} Activities</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">{selected.fullDescription}</p>

              <h4 className="font-bold text-[#e600a9] mb-3">What We Offer:</h4>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-[#ff00c8] text-[#e600a9] rounded-2xl p-8 shadow-md">
              ...
              <span className="inline-block mt-3 bg-[#e600a9] text-[#ff00c8] text-xs font-bold px-3 py-1 rounded-full">
                Coming Soon
              </span>
            </div>
