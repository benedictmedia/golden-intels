...
export default function Hero() {
  return (
    <div className="relative text-white min-h-[90vh] flex items-center justify-center overflow-hidden bg-sky-500">
      ...
      ></div>
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-sky-500/70"></div>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl font-bold font-serif leading-tight mb-6">
          Welcome to <br />
          <span className="text-sky-200">Golden-Intels</span> <br />
          International School
        </h1>

        {/* Subheading */}
        <p className="text-lg md:text-xl text-sky-50 max-w-2xl mx-auto mb-10">
          We nurture for nature.
        </p>

        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/admissions" className="bg-sky-200 hover:bg-sky-300 text-slate-950 font-bold px-8 py-3 rounded-lg text-lg transition-colors">
            Apply Now
          </Link>
          <Link to="/about" className="border-2 border-white hover:border-sky-200 hover:text-sky-200 text-white font-bold px-8 py-3 rounded-lg text-lg transition-colors">
            Learn More
          </Link>
          <Link to="/about" className="bg-white hover:bg-sky-100 text-sky-700 font-bold px-8 py-3 rounded-lg text-lg transition-colors">
            Discover Our Story
          </Link>
        </div>
