...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#5B21B6] text-white border-b border-white/30 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2">
          {/* Logo Circle */}
          <div className="w-10 h-10 bg-[#0EA5E9] rounded-full flex items-center justify-center font-bold text-white shadow-md">
            G
          </div>
          {/* School Name */}
        ...
        <Link
          to="/login"
          className="hidden lg:block bg-[#0EA5E9] hover:bg-[#0C85D0] text-white font-bold text-sm px-5 py-2 rounded-lg transition-all duration-300 shadow-md"
        >
          Portal Login
        </Link>
        {/* Mobile menu button */}
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="lg:hidden bg-[#5B21B6] border-t border-white/20 px-4 pb-6">
            ...
            {navLinks.map(link => (
              <li key={link.name}>
                <Link
                  ...
                  className="hover:text-[#F59E0B] transition-colors duration-300 block"
                >
                  {link.name}
                </Link>
              </li>
          ...
          <Link
            to="/login"
            className="mt-6 inline-block bg-[#0EA5E9] hover:bg-[#0C85D0] text-white font-bold text-sm px-5 py-2 rounded-lg transition-all duration-300"
          >
            Portal Login
          </Link>
        </div>
...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#800080] text-white border-b border-white/30 shadow-lg">
