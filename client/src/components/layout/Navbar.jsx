  ...
  return (
    <nav className="bg-blue-600 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        {/* Portal button */}
        <Link to="/login" className="hidden lg:block bg-blue-200 hover:bg-blue-300 text-cyan-900 font-bold text-sm px-4 py-2 rounded-lg transition-colors">
          Portal Login
        </Link>
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="lg:hidden bg-blue-600 border-t border-blue-300 px-4 pb-4">
          <ul className="flex flex-col gap-3 mt-3 text-sm">
            ...
            <li>
              <Link to="/login" className="block bg-blue-200 text-cyan-900 font-bold text-center py-2 rounded-lg mt-2">
                Portal Login
              </Link>
            </li>
          </ul>
