...
export default function AcademicExcellence() {
  ...
  return (
    ...
    <section className="py-20 bg-[#F8FAFC] text-[#1E293B]">
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-14">
        ...
        <div className="flex-1">
          ...
          {/* Heading */}
          <h2 className="text-3xl md:text-4xl font-bold font-serif text-[#0F172A] mb-6 leading-tight">
        ...
        <div className="flex-1">
          ...
          <img
            ...
            className="w-full h-[420px] object-cover rounded-2xl shadow-2xl border-4 border-white"
            loading="lazy"
            decoding="async"
          />
