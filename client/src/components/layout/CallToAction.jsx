    ...
    <section className="py-20 bg-[#2563eb] text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold font-serif text-white mb-6 leading-tight">
          ...
          <span className="text-[#60a5fa]">With Us</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            to="/contact"
            className="border-2 border-white/80 hover:border-[#2563eb] hover:text-[#2563eb] text-white font-bold px-8 py-3 rounded-lg text-lg transition-all duration-300"
          >
            Schedule a Visit
          </Link>
