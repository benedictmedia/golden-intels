                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between gap-1 mt-0.5">
                      ...
                      {conv.unreadCount > 0 && (
                        <span className="bg-[#1d4ed8] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full flex-shrink-0 min-w-[18px] text-center">
                          {conv.unreadCount}
                        </span>
                      )}
                    </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {!activeConv ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center bg-[#f0f2f5]">
            <div className="w-20 h-20 rounded-full bg-[#1d4ed8]/10 flex items-center justify-center mb-4">
              <MessageCircle size={36} className="text-[#1d4ed8]/30" />
            </div>
            ...
            {totalUnread > 0 && (
              <p className="text-xs text-[#1d4ed8] mt-2 font-semibold">{totalUnread} unread message{totalUnread > 1 ? 's' : ''}</p>
            )}
          </div>
        ) : (
          <>
            {/* ── Chat header ── */}
            <div className="bg-[#1d4ed8] text-white px-4 py-3 flex items-center gap-3 flex-shrink-0 shadow-md">
